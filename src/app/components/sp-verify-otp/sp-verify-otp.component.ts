...
export class SpVerifyOtpComponent {
  ...
  sendMobileOTP() {
    ...
    this.apiService.sendMobileOtpForServicePerson(mobile).subscribe(
      (response) => {
  ...
  sendEmailOTP() {
    ...
    this.apiService.sendEmailOtpForServicePerson(email).subscribe(
      (response) => {
  ...
  verifyMobileOTP() {
    ...
    this.apiService.verifyOtpByMobileForServicePerson(mobileData, enterOTP).subscribe(
      (response) => {
        if (response['status']){
  ...
  verifyEmailOTP() {
    ...
    this.apiService.verifyOtpByEmailForServicePerson(email, enterOTP).subscribe(
      (response) => {
        if (response['status']){
