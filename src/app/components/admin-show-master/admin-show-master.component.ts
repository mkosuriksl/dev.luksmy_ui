...
@Component({
  selector: 'app-admin-show-master',
  templateUrl: './admin-show-master.component.html',
  styleUrls: ['./admin-show-master.component.css']
})
export class AdminShowMasterComponent {
  records: any[] = [];
  selectedImages: any[] = [];
