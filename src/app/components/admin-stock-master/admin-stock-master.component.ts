...
@Component({
  selector: 'app-admin-stock-master',
  templateUrl: './admin-stock-master.component.html',
  styleUrls: ['./admin-stock-master.component.css']
})
export class AdminStockMasterComponent {
